...
% ---- List of Equations ----
% A custom "List of Equations" built with tocloft. Equations are registered with
% \eqname{<name>} placed just after the \label inside an equation environment; only
% the name and page appear in the list (not the equation itself).
\newcommand{\listequationsname}{List of Equations}
\newlistof{myequation}{loe}{\listequationsname}
\renewcommand{\cftmyequationpresnum}{\textbf{Equation~}}
\renewcommand{\cftmyequationaftersnum}{\textbf{:}\space}
\setlength{\cftmyequationnumwidth}{\widthof{\textbf{Equation~99: }}}
\newcommand{\eqname}[1]{%
