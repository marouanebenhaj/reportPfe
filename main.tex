...
\input{Section Files/1-introduction}
\clearpage
% Include the introduction section.

\input{Section Files/2-background-and-literature-review}
\clearpage
% Include the background and literature and literature review section.

\input{Section Files/3-methodology}
\clearpage
...
\input{Section Files/5-results-and-findings}
\clearpage
% Include the results and findings section.

\input{Section Files/6-discussion}
\clearpage
% Include the discussion section.


\input{Section Files/7-conclusion}
\clearpage
